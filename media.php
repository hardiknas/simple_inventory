				...
				if(!empty($_SESSION['dpId'])){
					...
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="<?php echo $_SESSION['dpFoto'];?>" alt="<?php echo $_SESSION['dpNama'];?>">
							<span class="user-info">
								<small>Selamat Datang,</small><?php echo $_SESSION['dpNama'];?>
							</span>
							<i class="icon-caret-down"></i>
						</a>
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							<li><a href="?page=profil"><i class="icon-user"></i>Profil</a></li>
