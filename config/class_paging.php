...
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET['halsemuaberita'])){
$posisi=0;
$_GET['halsemuaberita']=1;
}
else{
$posisi = ($_GET['halsemuaberita']-1) * $batas;
}
return $posisi;
}
...
if($halaman_aktif > 1){
$prev = $halaman_aktif-1;
$link_halaman .= "<a href=halsemuaberita-1.html class='nextprev'><< First</a>
                  <a href=halsemuaberita-$prev.html class='nextprev'>< Prev</a>";
}
else{
$link_halaman .= "<span class='nextprev'><< First</span><span class='nextprev'>< Prev </span> ";
}
...
if ($i < 1)
continue;
$angka .= "<a href=halsemuaberita-$i.html>$i</a>  ";
}
$angka .= " <span class='current'><b>$halaman_aktif</b></span>";
...
$angka .= ($halaman_aktif+2<$jmlhalaman ? "<span class='nextprev'>...</span><a href=halsemuaberita-$jmlhalaman.html>$jmlhalaman</a> " : " ");
...
if($halaman_aktif < $jmlhalaman){
$next = $halaman_aktif+1;
$link_halaman .= " <a href=halsemuaberita-$next.html class='nextprev'>Next ></a>
<a href=halsemuaberita-$jmlhalaman.html class='nextprev'>Last >></a> ";
}
else{
$link_halaman .= " <span class='nextprev'>Next ></span> <span class='nextprev'> Last >></span>";
}
